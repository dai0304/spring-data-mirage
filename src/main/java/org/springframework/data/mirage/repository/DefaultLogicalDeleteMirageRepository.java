 ...
 * @author daisuke
 */
public class DefaultLogicalDeleteMirageRepository<E extends Identifiable> extends IdentifiableMirageRepository<E>
		implements LogicalDeleteMirageRepository<E> {
	
	static final SqlResource BASE_SELECT_SQL = new ScopeClasspathSqlResource(
			DefaultLogicalDeleteMirageRepository.class, "baseLogicalDeleteSelect.sql");
	
	static final SqlResource BASE_LOGICAL_DELETE = new ScopeClasspathSqlResource(
			DefaultLogicalDeleteMirageRepository.class, "baseLogicalDelete.sql");
	 ...
	 */
	public DefaultLogicalDeleteMirageRepository(Class<E> entityClass) {
		super(entityClass);
	}
	 ...
	 * @param sqlManager
	 */
	public DefaultLogicalDeleteMirageRepository(EntityInformation<E, Long> entityInformation, SqlManager sqlManager) {
